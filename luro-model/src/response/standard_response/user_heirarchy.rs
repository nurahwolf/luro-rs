...
pub fn user_hierarchy_embed(username: &str) -> crate::builders::EmbedBuilder {
    tracing::warn!("The user {username} tried to abuse the bot's perms to do something they can't do");
