...
impl LuroDatabase {
    pub async fn update_character_fetish(&self, character: DbCharacterFetish) -> Result<DbCharacterFetish, sqlx::Error> {
        sqlx::query_as!(
            ...
            insert_2 AS (
                INSERT INTO user_characters_fetishes(category,character_name,fetish_id,user_id)
                VALUES ($1, $2, $4, $6)
            ...
            SELECT category as \"category: DbUserFetishCategory\", character_name, insert_1.fetish_id, user_id, name, description FROM insert_2
