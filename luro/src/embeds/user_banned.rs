...
use crate::{
    ...
    models::{
        emoji::{MEMBER_EMOJI, PRIVATE_EMOJI, TICKET_EMOJI},
        MemberContext, User,
    },
};
...
pub fn user_banned(
    ...
    writeln!(description, "{PRIVATE_EMOJI}`{purged_messages}`")?;
