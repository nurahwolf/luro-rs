...
use twilight_model::channel::{
    message::{
        Component, Embed, MessageActivity, MessageApplication, MessageFlags, MessageInteraction,
...
async fn fetch_message_sqlx(
    db: &Database,
    message_id: Id<MessageMarker>,
) -> Result<Option<Message>, Error> {
    let message = sqlx::query_file!(
        "src/database/sqlx_queries/message_fetch.sql",
