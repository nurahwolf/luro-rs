...
pub fn new_punishment_embed(
    ...
    kind: &crate::models::Punishment,
    moderator: &crate::models::User,
    ...
    let embed = match kind {
        crate::models::Punishment::Kicked(punishment_reason) => {
            writeln!(
                description,
        ...
        crate::models::Punishment::Unbanned(punishment_reason) => {
            writeln!(
                description,
                "<:member:1175114506465198171> <@{1}> - {} `{1}`",
                target.username(),
