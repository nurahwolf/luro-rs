use crate::{
    commands::guild::{command_info_channel::channel, command_info_guild::guild, command_info_user::user},
...
#[poise::command(slash_command, category = "Guild", subcommands("user", "guild", "channel"))]
