...
pub async fn test_reuse_response(ctx: Context<'_>) -> Result<(), Error> {
    ...
    ctx.send(|b| {
        b.content("message 1")
            ...
            .components(|b| b.create_action_row(|b| b.create_button(|b| b.label("button 1").style(serenity::ButtonStyle::Primary).custom_id(1))))
    })
    .await?;
    ...
    ctx.send(|b| {
        b.content("message 2")
            ...
            .components(|b| b.create_action_row(|b| b.create_button(|b| b.label("button 2").style(serenity::ButtonStyle::Danger).custom_id(2))))
    })
    .await?;
